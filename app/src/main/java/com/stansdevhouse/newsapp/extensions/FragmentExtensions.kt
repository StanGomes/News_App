package com.stansdevhouse.newsapp.extensions
 ...
 */
fun <T> Fragment.fragmentBinding(): ReadWriteProperty<Fragment, T> =
    ...
    object : ReadWriteProperty<Fragment, T>, DefaultLifecycleObserver {
        ...
        init {
            ...
            this@fragmentBinding
                ...
                .observe(this@fragmentBinding, Observer { owner: LifecycleOwner? ->
